...
export function getVersionInfo(): VersionInfo {
  ...
  cachedInfo = {
    ...
    highlights: [
      '🆕 Developer Mode: /dev voor volledige coding workflow',
      '🆕 Project Context: /project open <pad> voor file browsing',
      '🆕 File Operations: /files, /tree, /read, /write',
      '🆕 Focus System: /focus add <bestand> voor AI context',
      '🆕 Patch Management: /patch voor code wijzigingen',
      '🆕 Enhanced /code met project context',
    ],
    features: [
      '💬 AI Chat (Claude/GLM-4.7)',
