...
export function getVersionInfo(): VersionInfo {
  ...
  cachedInfo = {
    ...
    highlights: [
      '🔥 Multi-LLM provider switch (/llm)',
      '🧠 Mistral provider toegevoegd',
      '🆕 MiniMax v2.1 integratie met auto Lite fallback',
      '🐛 Bugfixes: streaming updates en timers verbeterd',
      '🔧 Enhanced error handling en logging',
    ],
    features: [
      '💬 Multi-LLM AI Chat (Z.ai/MiniMax/Mistral/Claude CLI optioneel)',
